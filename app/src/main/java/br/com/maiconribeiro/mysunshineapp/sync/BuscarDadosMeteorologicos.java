...
/**
 * Created by maiconwillianribeiro on 10/09/16.
 */
public class BuscarDadosMeteorologicos extends AsyncTask<String, Void, String[]> {

    private final String LOG_TAG = BuscarDadosMeteorologicos.class.getSimpleName();

    private final String URL_BASE = "http://api.openweathermap.org/data/2.5/forecast/daily?";
    ...
    private final String DAYS_VALUE = "7";
    ...
    private final String LANG_VALUE = "pt";
